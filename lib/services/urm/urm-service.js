...
exports = module.exports = class URMService {
    ...
    initSocket() {
        ...
        if (this._options.socket.proxy !== false) {
            this.log.info('setup urm socket with proxy');
            this._options.socketClient = socketProxy.connect;
        } else {
            this.log.info('setup urm socket without proxy');
            this._options.socketClient = socketClient;
        }
