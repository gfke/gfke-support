...
const RedisSentinelCacheStrategy = require('./redis-sentinel-cache-strategy');
    ...
    set strategy(strategy) {
        switch (strategy.toLowerCase()) {
            ...
            case CacheContext.CacheStrategies.Redis:
                ...
                break;
            case CacheContext.CacheStrategies.RedisSentinel:
                this._strategy = new RedisSentinelCacheStrategy();
                break;
            default:
