...
module.exports = class Monitor {
    ...
    collectSystemMetrics() {
        ...
        return co(function*() {
            ...
            if (_.has(self.strategy.opts.systemMetrics)) {
                return _.pick(metrics, self.strategy.opts.systemMetrics);
            }
    ...
    collectProcessMetrics() {
        ...
        if (_.has(self.strategy.opts.processMetrics)) {
            return _.pick(metrics, self.strategy.opts.processMetrics);
        }
